    ...
    <main className="bg-page">
      ...
      <div className="container py-6">
        <div className="mb-5 flex flex-wrap items-center justify-between gap-3">
          <div>
            <p className="text-[12px] font-semibold uppercase tracking-[0.12em] text-fb-pink">Fit Bazar Launch</p>
        ...
        <section className="section mt-6">
          <div className="grid gap-4 lg:grid-cols-[360px_minmax(0,1fr)]">
            <div className="rounded-[8px] border border-border-light bg-card p-5 shadow-[var(--shadow-card)]">
              <p className="text-[12px] font-semibold uppercase tracking-[0.12em] text-fb-pink">How it works</p>
              ...
              <div className="mt-5 space-y-3">
                {steps.map((step, index) => (
                  <div key={step} className="grid grid-cols-[36px_minmax(0,1fr)] gap-3">
                    <span className="flex h-9 w-9 items-center justify-center rounded-[6px] bg-[#101827] text-[13px] font-bold text-white">
                      {index + 1}
                    </span>
            ...
            <div className="rounded-[8px] border border-border-light bg-card p-5 shadow-[var(--shadow-card)]">
              <div className="mb-5 flex flex-wrap items-end justify-between gap-3">
                <div>
                  <p className="text-[12px] font-semibold uppercase tracking-[0.12em] text-fb-pink">Mobile previews</p>
                  <h2 className="mt-2 text-[1.55rem] leading-tight">Android and iOS ready shopping flow</h2>
                </div>
                <span className="rounded-[4px] bg-[#101827] px-3 py-1.5 text-[11px] font-semibold uppercase tracking-[0.1em] text-white">
                  App style web
                </span>
              </div>
              ...
              <div className="space-y-5">
                {previewRows.map((row) => (
                  <div key={row.label}>
                    <div className="mb-3 inline-flex items-center gap-2 rounded-[4px] bg-[#101827] px-3 py-1.5 text-[12px] font-semibold text-white">
                    ...
                    <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 xl:grid-cols-6">
                      {row.screens.map((screen) => (
                        <div
                          ...
                          className="rounded-[12px] border border-border-light bg-white p-2 shadow-[0_14px_34px_rgba(16,24,39,0.08)]"
                        >
                          <div className={`rounded-[8px] ${screen.tone} p-3`}>
                            <div className="flex items-center justify-between">
                              <span className="h-1.5 w-8 rounded-full bg-[#101827]/25" />
                              <span className="h-2 w-2 rounded-full bg-[#101827]/35" />
                            </div>
                            <div className="mt-6 flex h-16 items-center justify-center rounded-[8px] bg-white/82">
                              <screen.icon className="h-8 w-8 text-[#101827]" strokeWidth={1.7} />
                            </div>
