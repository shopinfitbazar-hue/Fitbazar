...
function ProductsPageInner() {
  ...
  const pageHeading = selectedCategory
    ...
    : selectedDiscount
      ? "Fashion Sale in Nepal"
      : "Online Fashion Shopping in Nepal";
  const pageIntro = selectedCategory
    ? `Shop ${selectedCategory.toLowerCase()} from trusted FitBazar stores with clear pricing, sizes, colors, and mobile-first checkout.`
    : selectedDiscount
      ? "Browse discounted clothing, footwear, accessories, and seasonal fashion offers from Nepal-based sellers."
      : "Explore men's, women's, kids', ethnic, sportswear, footwear, and accessories from trusted fashion stores across Nepal.";
